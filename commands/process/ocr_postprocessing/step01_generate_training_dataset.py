...
Carefully analyze the information you are given to accurately determine the type of the text in `<current>`. Return a TYPE and nothing else.
"""
...
def step01_generate_training_dataset(
    ...
    """
    OCR Post-processing step 01: Generate a training dataset.
...
def assign_ocr_chunk_type(
    ...
    # Remove PAGE_NUMBER from prompt if we're either:
